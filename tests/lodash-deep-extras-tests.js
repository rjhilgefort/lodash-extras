...
describe(
  ...
  function () {
    ...
    describe('isElement', () => {
      function Element() { this.nodeType = 1; }
    ...
    describe('deepDelete', () => {
      ...
      describe('objects', () => {
        let testObject;
        beforeEach(() => {
          testObject = { level1: 'foo', level2: { foo: 'bar' } };
        });
      ...
      describe('mixed', () => {
        ...
        beforeEach(() => {
          testArray = [1, 2, [1, 2, 3], 4];
          testObject = { level1: 'foo', level2: { foo: testArray } };
          testCase = [1, testObject];
        });
