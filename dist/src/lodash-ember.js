...
exports.promiseReject = exports.promiseResolve = exports.typeOf = exports.shift = exports.pop = exports.clone = exports._clone = exports.isEmpty = exports._isEmpty = exports.set = exports._set = exports.get = exports._get = exports.map = exports._map = exports.reduce = exports._reduce = exports.forEach = exports._forEach = exports.isEmberTransition = exports.isEmberCollection = exports.isEmberArrayProxy = exports.isEmberObjectProxy = exports.isEmberObject = exports.isEmberInstance = exports.lodashEmber = undefined;
 ...
 */
var lodashEmber = exports.lodashEmber = {};
 ...
 */
var isEmberInstance = exports.isEmberInstance = function isEmberInstance(value) {
 ...
 * @return {Boolean}
 */
var isEmberObject = exports.isEmberObject = _lodashUtils2.default.makeIsType(Ember.Object);
 ...
 * @return {Boolean}
 */
var isEmberObjectProxy = exports.isEmberObjectProxy = _lodashUtils2.default.makeIsType(Ember.ObjectProxy);
 ...
 * @return {Boolean}
 */
var isEmberArrayProxy = exports.isEmberArrayProxy = _lodashUtils2.default.makeIsType(Ember.ArrayProxy);
 ...
 * @return {Boolean}
 */
var isEmberCollection = exports.isEmberCollection = function isEmberCollection(value) {
 ...
 * @return {Boolean}
 */
var isEmberTransition = exports.isEmberTransition = function isEmberTransition(value) {
 ...
 */
var _forEach = exports._forEach = _.forEach;
 ...
 * @returns {Array|Object|String} Returns `collection`.
 */
var forEach = exports.forEach = function forEach(collection, callback, thisArg) {
 ...
 * @returns {Array|Object|String} Returns `collection`.
 */
var _reduce = exports._reduce = _.reduce;
 ...
 * @returns {Array|Object|String} Returns `collection`.
 */
var reduce = exports.reduce = function reduce(collection, callback, currentValue, thisArg) {
  if (_.isEmberArrayProxy(collection)) {
 ...
 * @returns {Array|Object|String} Returns `collection`.
 */
var map = exports.map = function map(collection, callback, thisArg) {
  if (_.isEmberArrayProxy(collection)) {
 ...
 * @returns {*} The value, or undefined if it doesn't exists.
 */
var get = exports.get = function get(collection, propertyPath) {
 ...
 * @returns {*} The `collection` passed in with value set.
 */
var set = exports.set = function set(collection, propertyPath, value) {
  // Handle Ember Objects
  if (isEmberObject(collection) || isEmberObjectProxy(collection)) {
 ...
 * @return {Boolean}
 */
var _isEmpty = exports._isEmpty = _.isEmpty;
 ...
 * @return {*}
 */
var _clone = exports._clone = _.clone;
 ...
 * @return {*}
 */
var pop = exports.pop = function pop(value) {
 ...
 * @return {*}
 */
var shift = exports.shift = function shift(value) {
 ...
 * @return {Promise}
 */
var promiseResolve = exports.promiseResolve = function promiseResolve(value) {
 ...
 * @return {Promise}
 */
var promiseReject = exports.promiseReject = function promiseReject(message) {
 ...
 * @return {Boolean}
 */
_lodashUtils2.default.buildIsMethods(lodashEmber, lodashEmber);

var lodashEmber = exports.lodashEmber = undefined;
